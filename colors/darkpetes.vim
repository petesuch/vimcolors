...
hi Normal       guifg=white     guibg=#1E1E28  ctermfg=white   ctermbg=black     gui=none      cterm=none
hi Comment      guifg=#8A8A8A   guibg=#1E1E28  ctermfg=200     ctermbg=NONE      gui=none      cterm=none
hi Constant     guifg=#D717Bf   guibg=#1E1E28  ctermfg=187     ctermbg=NONE      gui=none      cterm=none
...
hi Conditional  guifg=#FF6B13   guibg=gray15    gui=bold
